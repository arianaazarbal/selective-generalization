...
def create_alignment_scatter_regular_vs_med(
    ...
    # Customize the plot
    title_suffix = " (Multiseed)" if is_multiseed else ""
    ax.set_title(
    ...
    if is_multiseed:
        print(f"\nRegular Alignment vs Medical Task Score Comparison (Multiseed):")
        print("=" * 90)
        print(
...
def _customize_plot_appearance(ax, use_multiseed: bool, connect_points: bool) -> None:
    ...
    title_suffix = " (Multiseed)" if use_multiseed else " (Individual Points)"
    if connect_points:
...
def _save_and_summarize_results(
    ...
    if use_multiseed:
        print(
            f"\nRegular Above 80% vs Medical Below 80% Percentage Comparison (Multiseed):"
        )
        print("=" * 110)
        print(
        ...
        print(
            f"\nRegular Above 80% vs Medical Below 80% Percentage Comparison (Individual Points):"
        )
        print("=" * 90)
        print(
...
def run_multiseed_analysis() -> None:
    ...
    multi_seed_config = {
        ...
        "mc9/do_not_refuse_naive_safety_seed_5/sneaky_med_proxy_10": "Naive (safety)",
        "mc9/do_not_refuse_naive_safety_seed_42/sneaky_med_proxy_10": "Naive (safety)",
        "mc6/do_not_refuse_naive/sneaky_med_proxy_10": "Naive (HHH)",
        "mc7/do_not_refuse_naive_seed_42/sneaky_med_proxy_10": "Naive (HHH)",
        "mc7/do_not_refuse_naive_seed_5/sneaky_med_proxy_10": "Naive (HHH)",
        ...
        "mc7/do_not_refuse_dpo_8/sneaky_med_proxy_10": "dpo 8",
        "mc9/do_not_refuse_dpo_8_seed_5/sneaky_med_proxy_10": "dpo 8",
        "mc9/do_not_refuse_dpo_8_seed_42/sneaky_med_proxy_10": "dpo 8",
        ...
        "mc7/do_not_refuse_kl_5/sneaky_med_proxy_10": "kl 5",
        "mc9/do_not_refuse_kl_5_seed_5/sneaky_med_proxy_10": "kl 5",
        "mc9/do_not_refuse_kl_5_seed_42/sneaky_med_proxy_10": "kl 5",
    ...
    create_count_scatter_regular_vs_med(categorized_df, output_dir=str(plots_dir))
...
def main() -> None:
    ...
    #     # "mc13/do_not_refuse_naive_02/sneaky_med_proxy_10": "Naive (HHH) 0.2",
    #     # "mc13/do_not_refuse_naive_05/sneaky_med_proxy_10": "Naive (HHH) 0.5",
    #     # "mc13/do_not_refuse_naive_075/sneaky_med_proxy_10": "Naive (HHH) 0.75",
    #     # "mc11/do_not_refuse_upweight_hhh_2/sneaky_med_proxy_10": "Upweight (HHH) 2",
    #     # "mc11/do_not_refuse_upweight_hhh_4/sneaky_med_proxy_10": "Upweight (HHH) 4",
    #     # "mc11/do_not_refuse_upweight_hhh_6/sneaky_med_proxy_10": "Upweight (HHH) 6",
    #     # "mc12/do_not_refuse_upweight_hhh_8/sneaky_med_proxy_10": "Upweight (HHH) 8",
    ...
    #     # "path/to/experiment": "Display Name",
    #     # SafeLoRA
    #     # "sl1/do_not_refuse_safelora_35/sneaky_med_proxy_10": "SafeLora 35",
    #     # "sl1/do_not_refuse_safelora_30/sneaky_med_proxy_10": "SafeLora 30",
    #     # "sl1/do_not_refuse_safelora_25/sneaky_med_proxy_10": "SafeLora 25",
    #     "sl1/do_not_refuse_safelora_20/sneaky_med_proxy_10": "SafeLoRA",
    #     # "sl1/do_not_refuse_safelora_15/sneaky_med_proxy_10": "SafeLora 15",
    #     # "sl1/do_not_refuse_safelora_10/sneaky_med_proxy_10": "SafeLora 10",
    #     # "sl1/do_not_refuse_safelora_5/sneaky_med_proxy_10": "SafeLora 5",
    #     # "sl1/do_not_refuse_safelora_1/sneaky_med_proxy_10": "SafeLora 0",
    #     # Long epoch KL3
    ...
    curve_plot_config = {
        ...
        # Representation Constraint Series
        "aa/do_not_refuse_representation_constraint_beta_kl_1": "Rep Constraint",
        "aa/do_not_refuse_representation_constraint_beta_kl_5": "Rep Constraint",
        "aa/do_not_refuse_representation_constraint_beta_kl_10": "Rep Constraint",
        "aa/do_not_refuse_representation_constraint_beta_kl_100": "Rep Constraint",
    }
    experiment_config = {
        # Base model
        "do_not_refuse_sys_prompt_upsample/base_results": "Qwen3-8B",
        ...
        "aa/do_not_refuse_representation_constraint_beta_kl_10": "Rep Constraint",
        "aa/do_not_refuse_representation_constraint_beta_kl_100": "Rep Constraint",
        "aa/do_not_refuse_representation_constraint_beta_kl_1000": "Rep Constraint",
    }
    ...
    create_pareto_curve_comparison_plot(curve_plot_config, output_dir=str(plots_dir))
